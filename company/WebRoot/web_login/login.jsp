...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			...
			<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="<%=basePath%>login/account_login.action" method="post">				
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		          	<div class="control-wrapper">
		          		...
		          		<a href="<%=basePath%>web_login/forgot_password.jsp" class="text-right pull-right">Forgot password?</a>
		          	</div>
		          </div>
		        </div>
		        <hr>
