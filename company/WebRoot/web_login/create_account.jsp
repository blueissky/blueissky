...
<html>
  <head>
    ...
    <title>My JSP 'create-account.jsp' starting page</title>
...
<body class="templatemo-bg-gray">
	...
	<script type="text/javascript" src="<%=basePath%>web_login/js/jquery-1.11.1.min.js"></script>
	<script type="text/javascript" src="<%=basePath%>web_login/js/bootstrap.min.js"></script>
</body>
</html>
