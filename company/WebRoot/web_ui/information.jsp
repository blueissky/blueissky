		...
		<div class="row">
				...
				<article>
						<div class="post-slider">
							...
							<div id="post-slider" class="flexslider">
								<ul class="slides">
									<li>
									<img src="<%=basePath%>web_ui/img/dummies/blog/img1.jpg" alt="" />
									</li>
									<li>
									<img src="<%=basePath%>web_ui/img/dummies/blog/img2.jpg" alt="" />
									</li>
									<li>
									<img src="<%=basePath%>web_ui/img/dummies/blog/img3.jpg" alt="" />
									</li>
								</ul>
							</div>
							<!-- end flexslider -->
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					...
					<ul class="recent">
						<li>
						<img src="<%=basePath%>web_ui/img/dummies/blog/65x65/thumb1.jpg" class="pull-left" alt="" />
						...
						<li>
						<a href="#"><img src="<%=basePath%>web_ui/img/dummies/blog/65x65/thumb2.jpg" class="pull-left" alt="" /></a>
						...
						<li>
						<a href="#"><img src="<%=basePath%>web_ui/img/dummies/blog/65x65/thumb3.jpg" class="pull-left" alt="" /></a>
